...
export class PassengerService {
 ...
 Fetchallpassengers():Array<Ipassenger>{
  // api call to fetch all passengers data
  return this.passengerArray
 } 

 updatepassinfo(updatepassobj:Ipassenger){
  let getupdateindex=this.passengerArray.findIndex(pass=>pass.id===updatepassobj.id)
  this.passengerArray[getupdateindex]=updatepassobj;
