...
var movieArray01 = document.getElementById('cardContainer');
    ...
    result += `   <div class="col-md-4">
				<div class="card mb-4">
				  <figure class="moviecard mb-0">
				    <img src="https://image.tmdb.org/t/p/w342${movieArray[i].poster_path}"
					 alt="MovieLogo" title="MovieLogo">
					 <figcaption>
					    <div class="rating-sec">
						  <div class="row">
						     <div class="col-10">
							    <h3 class="moviename mb-0">${movieArray[i].title}</h3>
							 </div>
						     <div class="col-2 align-self-center mb-0">
							    
								${movieArray[i].vote_average >= 8 ? `<span class="bg-success">${movieArray[i].vote_average}</span>` :
							     movieArray[i].vote_average<= 7 && movieArray[i].vote_average>=5 ? `<span class="bg-warning">${movieArray[i].vote_average}</span>` : 
								 movieArray[i].vote_average<5 ? `<span class="bg-danger">${movieArray[i].vote_average}</span>`:
