...
movieArray.forEach(para=>{
	
	result+=`
			<div class="col-md-4">
				<div class="card mb-5">
					<figure class="movieCard mb-0">
						<img src="https://image.tmdb.org/t/p/w342${para.poster_path}" alt="">
						<figcaption>
							<div class="ratingSection">
								<div class="row">
									...
									<div class="col-2 align-self-center">
											${para.vote_average >= 8 ? `<p class="bg-success">${para.vote_average}</p>` :
													para.vote_average<= 7 && para.vote_average>=5 ? `<p class="bg-warning">${para.vote_average}</p>` : 
													para.vote_average<5 ? `<p class="bg-danger">${para.vote_average}</p>`:`<p class="bg-warning">${para.vote_average}</p>`}
									</div>
								</div>
							</div>
